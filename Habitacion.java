...
public class Habitacion 
{
    ...
    private TreeMap<Salida, Habitacion> salidas;
...
/* Informatica Avanzada - 2021 */
    ...
    public void addElemento (Elemento elemento) {
      if(elemento.getTipo().equals(TipoElemento.LIQUIDO)){
        ...
        System.out.println(elemento.getNombre() + ": se acaba de derramar al piso");
      }else{
    ...
    public Elemento getElemento (String nombre) {
        ...
        System.out.println(elementos.get(nombre).getNombre() + ": No se puede tomar");
        return null;
      }else if(elementos.get(nombre) == null){
